  ...
  <div>
    <form>
      ...
      <fieldset>
        ...
        <label>
          <input type="checkbox" v-model="outputPrinter" value="clonet" />3D DNA Cloner
        </label><br>
        <input class="styled-button" type="submit" value="Print Now" @click.prevent="printHandler">
      </fieldset>
    </form>
    <!-- 선택된 프린터 목록을 표시합니다. -->
    <p>Selected printers: {{ outputPrinter.join(', ') }}</p>
  </div>
</template>
